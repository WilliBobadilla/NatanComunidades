"""
Django settings for NatanComunidades project.
...
SECRET_KEY = 'k72yfjb)ysh1j^+8!3rn)j^8lu5oae5@k5kev2#y*7s@i3in$g'
...
WSGI_APPLICATION = 'NatanComunidades.wsgi.application'
